...
namespace MaticeApp
{
    public partial class MatrixCalculator : UserControl
    {
        ...
        private Brush Button2MatrixOperationsBackgroundNormal = new SolidColorBrush(Color.FromArgb(255, 161, 250, 255));
        private Brush ButtonMatrixFillBackgroundNormal = new SolidColorBrush(Color.FromArgb(255, 161, 221, 255));
        private Brush Button1MatrixOperationBackgroundNormal = new SolidColorBrush(Color.FromArgb(255, 161, 183, 255));
